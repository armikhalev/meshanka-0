window.CLOSURE_UNCOMPILED_DEFINES = {"figwheel.repl.connect_url":"ws:\/\/localhost:9500\/figwheel-connect?fwprocess=3b58d0&fwbuild=test"};
...
document.write('<script>goog.require("meshanka.test_runner");</script>');
