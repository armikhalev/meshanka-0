...
var len__4864__auto___14231 = arguments.length;
var i__4865__auto___14232 = (0);
while(true){
if((i__4865__auto___14232 < len__4864__auto___14231)){
args__4870__auto__.push((arguments[i__4865__auto___14232]));

var G__14233 = (i__4865__auto___14232 + (1));
i__4865__auto___14232 = G__14233;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq14228){
...
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__14229,G__14230,seq14228__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__14234_SHARP_){
return (!((cljs.core.meta.call(null,p1__14234_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.call(null,map__14235__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e14236){var _e__13707__auto__ = e14236;
return false;
}})();
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
...
}catch (e14238){var _e__13707__auto__ = e14238;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__14240 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__14241 = devtools.formatters.state.get_current_state.call(null);
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__14241);
...
var markup_db = cljs.core.get.call(null,map__14242__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__14240);
}});
...
var temp__5718__auto___14246 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5718__auto___14246)){
var managed_print_level_14247 = temp__5718__auto___14246;
var _STAR_print_level_STAR__orig_val__14244_14248 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__14245_14249 = managed_print_level_14247;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__14245_14249);

try{devtools.formatters.state.update_current_state_BANG_.call(null,(function (p1__14243_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__14243_SHARP_,null);
}));

job_fn.call(null);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__14244_14248);
}} else {
job_fn.call(null);
}
