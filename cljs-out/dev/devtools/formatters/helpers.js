...
var G__14190 = devtools.prefs.pref.call(null,v);
v = G__14190;
continue;
} else {
return v;
...
}catch (e14191){var _e__13707__auto__ = e14191;
return false;
}})();
...
}catch (e14193){var _e__13707__auto__ = e14193;
return false;
}})();
...
}catch (e14195){var _e__13707__auto__ = e14195;
return false;
}}
}
});
...
var vec__14197 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__14197,(0),null);
var name = cljs.core.nth.call(null,vec__14197,(1),null);
...
return cljs.core.some.call(null,(function (p1__14200_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__14200_SHARP_);
}),template);
});
