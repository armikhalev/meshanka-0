...
var o13880 = temp__5718__auto__;
var temp__5718__auto____$1 = (o13880["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o13881 = temp__5718__auto____$1;
return (o13881["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__13700__auto__ = f;
return (o__13700__auto__["toString"]).call(o__13700__auto__);
} else {
return "";
}
}catch (e13882){var _ = e13882;
return "";
}});
...
try{var o__13700__auto___13884 = t;
(o__13700__auto___13884["cljs$lang$ctorPrWriter"]).call(o__13700__auto___13884,t,writer);
}catch (e13883){var __13885 = e13883;
}
...
var char_code = (function (){var o__13700__auto__ = (new String(char$));
return (o__13700__auto__["charCodeAt"]).call(o__13700__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__13700__auto__ = String;
return (o__13700__auto__["fromCharCode"]).call(o__13700__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__13886 = num_code;
switch (G__13886) {
case (1):
return (185);
...
var o__13700__auto__ = String;
return (o__13700__auto__["fromCharCode"]).call(o__13700__auto__,superscript_code);
});
/**
...
}catch (e13888){var _e__13707__auto__ = e13888;
return false;
}})())){
...
var vec__13889 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__13889,(0),null);
...
var len__4864__auto___13898 = arguments.length;
var i__4865__auto___13899 = (0);
while(true){
if((i__4865__auto___13899 < len__4864__auto___13898)){
args__4870__auto__.push((arguments[i__4865__auto___13899]));

var G__13900 = (i__4865__auto___13899 + (1));
i__4865__auto___13899 = G__13900;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__13894){
var vec__13895 = p__13894;
var ns_detector = cljs.core.nth.call(null,vec__13895,(0),null);
...
var G__13901 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__13902 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__13901;
remaining_tokens = G__13902;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq13892){
var G__13893 = cljs.core.first.call(null,seq13892);
var seq13892__$1 = cljs.core.next.call(null,seq13892);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13893,seq13892__$1);
}));
...
var vec__13906 = cljs.core.split_with.call(null,(function (p1__13905_SHARP_){
return cljs.core.not_EQ_.call(null,p1__13905_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__13906,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__13906,(1),null);
...
var vec__13912 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__13912,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__13912,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__13915 = cljs.core.rest.call(null,remaining_tokens);
var G__13916 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__13915;
name_tokens = G__13916;
continue;
} else {
...
var vec__13919 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__13919,(0),null);
var arity = cljs.core.nth.call(null,vec__13919,(1),null);
var vec__13922 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__13922,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__13922,(1),null);
var vec__13925 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__13925,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__13925,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__13925,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__13925,(3),null);
...
var vec__13931 = result;
var munged_ns = cljs.core.nth.call(null,vec__13931,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__13931,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__13931,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__13931,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__13931,(4),null);
var arity = cljs.core.nth.call(null,vec__13931,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__13935 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__13935,(0),null);
var args = cljs.core.nth.call(null,vec__13935,(1),null);
var vec__13938 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__13938,(0),null);
var name = cljs.core.nth.call(null,vec__13938,(1),null);
...
var G__13941 = (arity + (1));
var G__13942 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__13943){
var vec__13944 = p__13943;
var arity = cljs.core.nth.call(null,vec__13944,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__13944,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__13947_SHARP_){
return cljs.core.get.call(null,arities,p1__13947_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__13948_SHARP_){
return cljs.core.drop.call(null,(2),p1__13948_SHARP_);
}),sorted_infos);
...
var args__4870__auto__ = [];
var len__4864__auto___13955 = arguments.length;
var i__4865__auto___13956 = (0);
while(true){
if((i__4865__auto___13956 < len__4864__auto___13955)){
args__4870__auto__.push((arguments[i__4865__auto___13956]));

var G__13957 = (i__4865__auto___13956 + (1));
i__4865__auto___13956 = G__13957;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__13951){
var vec__13952 = p__13951;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__13952,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq13949){
var G__13950 = cljs.core.first.call(null,seq13949);
var seq13949__$1 = cljs.core.next.call(null,seq13949);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13950,seq13949__$1);
}));
...
var map__13960 = options;
var map__13960__$1 = cljs.core.__destructure_map.call(null,map__13960);
var include_ns_QMARK_ = cljs.core.get.call(null,map__13960__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__13960__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__13960__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__13960__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__13961 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__13961,(0),null);
var fn_name = cljs.core.nth.call(null,vec__13961,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__13961,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__13961,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__13961,(4),null);
var arity = cljs.core.nth.call(null,vec__13961,(5),null);
...
var o__13700__auto__ = f;
return (o__13700__auto__["getBasis"]).call(o__13700__auto__);
});
/**
...
}catch (e13964){var _e__13707__auto__ = e13964;
...
var G__13965 = (obj[cljs.core.first.call(null,path)]);
var G__13966 = cljs.core.rest.call(null,path);
obj = G__13965;
path = G__13966;
continue;
} else {
...
var _STAR_ = (function (accum,p__13967){
var vec__13968 = p__13967;
var bit = cljs.core.nth.call(null,vec__13968,(0),null);
var protocol = cljs.core.nth.call(null,vec__13968,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__13971){
var vec__13972 = p__13971;
var ns = cljs.core.nth.call(null,vec__13972,(0),null);
var name = cljs.core.nth.call(null,vec__13972,(1),null);
var selector = cljs.core.nth.call(null,vec__13972,(2),null);
...
var post_process = (function (p__13976){
var vec__13977 = p__13976;
var munged_name = cljs.core.nth.call(null,vec__13977,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__13977,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__13975_SHARP_){
return (obj[cljs.core.first.call(null,p1__13975_SHARP_)]);
}),sorted_matches);
