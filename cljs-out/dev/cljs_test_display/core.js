...
var node = cljs_test_display.core.n.call(null,new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"id","id",-1388402092),"cljs-test-display-style"], null),style_string_13127);
...
var len__4864__auto___13131 = arguments.length;
var i__4865__auto___13132 = (0);
while(true){
if((i__4865__auto___13132 < len__4864__auto___13131)){
args__4870__auto__.push((arguments[i__4865__auto___13132]));

var G__13133 = (i__4865__auto___13132 + (1));
i__4865__auto___13132 = G__13133;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs_test_display.core.n.cljs$lang$applyTo = (function (seq13128){
...
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13129,G__13130,seq13128__$2);
}));
...
var vec__13134 = ((clojure.string.starts_with_QMARK_.call(null,cljs.core.first.call(null,classes),"#"))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,cljs.core.first.call(null,classes),(1)),cljs.core.rest.call(null,classes)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,classes], null));
var id = cljs.core.nth.call(null,vec__13134,(0),null);
var classes__$1 = cljs.core.nth.call(null,vec__13134,(1),null);
var G__13137 = cljs.core.PersistentArrayMap.EMPTY;
var G__13137__$1 = (cljs.core.truth_(id)?cljs.core.assoc.call(null,G__13137,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__13137);
if(cljs.core.truth_(cljs.core.not_empty.call(null,classes__$1))){
return cljs.core.assoc.call(null,G__13137__$1,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",classes__$1));
} else {
return G__13137__$1;
}
} else {
...
return (function() { 
var G__13141__delegate = function (klass,contents){
var vec__13138 = (((klass instanceof cljs.core.Keyword))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [klass,contents], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.cons.call(null,klass,contents)], null));
var klass__$1 = cljs.core.nth.call(null,vec__13138,(0),null);
var contents__$1 = cljs.core.nth.call(null,vec__13138,(1),null);
...
var G__13141 = function (klass,var_args){
var contents = null;
...
while (G__13142__i < G__13142__a.length) {G__13142__a[G__13142__i] = arguments[G__13142__i + 1]; ++G__13142__i;}
  contents = new cljs.core.IndexedSeq(G__13142__a,0,null);
} 
return G__13141__delegate.call(this,klass,contents);};
G__13141.cljs$lang$maxFixedArity = 1;
G__13141.cljs$lang$applyTo = (function (arglist__13143){
var klass = cljs.core.first(arglist__13143);
var contents = cljs.core.rest(arglist__13143);
return G__13141__delegate(klass,contents);
});
...
cljs_test_display.core.process_file_name = (function cljs_test_display$core$process_file_name(p__13147){
var map__13148 = p__13147;
var map__13148__$1 = cljs.core.__destructure_map.call(null,map__13148);
var ns = cljs.core.get.call(null,map__13148__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
...
cljs_test_display.core.comparison = (function cljs_test_display$core$comparison(p__13149){
var map__13150 = p__13149;
var map__13150__$1 = cljs.core.__destructure_map.call(null,map__13150);
var actual = cljs.core.get.call(null,map__13150__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
var expected = cljs.core.get.call(null,map__13150__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
...
cljs_test_display.core.error_comparison = (function cljs_test_display$core$error_comparison(p__13151){
var map__13152 = p__13151;
var map__13152__$1 = cljs.core.__destructure_map.call(null,map__13152);
var expected = cljs.core.get.call(null,map__13152__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
var actual = cljs.core.get.call(null,map__13152__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
...
cljs.core.swap_BANG_.call(null,cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__13153_SHARP_){
return cljs.core.cons.call(null,new_current_node,p1__13153_SHARP_);
}));
...
var curr_node = cljs_test_display.core.current_node.call(null);
var map__13155 = cljs_test_display.core.current_var_info.call(null);
var map__13155__$1 = cljs.core.__destructure_map.call(null,map__13155);
var info = map__13155__$1;
var name = cljs.core.get.call(null,map__13155__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var line = cljs.core.get.call(null,map__13155__$1,new cljs.core.Keyword(null,"line","line",212345235));
...
cljs.core.swap_BANG_.call(null,cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__13154_SHARP_){
return cljs.core.cons.call(null,node,p1__13154_SHARP_);
}));

return goog.dom.appendChild(curr_node,node);
});
cljs_test_display.core.summary = (function cljs_test_display$core$summary(p__13156){
var map__13157 = p__13156;
var map__13157__$1 = cljs.core.__destructure_map.call(null,map__13157);
var m = map__13157__$1;
var fail = cljs.core.get.call(null,map__13157__$1,new cljs.core.Keyword(null,"fail","fail",1706214930));
var error = cljs.core.get.call(null,map__13157__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var pass = cljs.core.get.call(null,map__13157__$1,new cljs.core.Keyword(null,"pass","pass",1574159993));
var test = cljs.core.get.call(null,map__13157__$1,new cljs.core.Keyword(null,"test","test",577538877));
...
var temp__5720__auto___13158 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___13158)){
var message_13159 = temp__5720__auto___13158;
cljs.core.println.call(null,message_13159);
} else {
}
...
var temp__5720__auto___13160 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___13160)){
var message_13161 = temp__5720__auto___13160;
cljs.core.println.call(null,message_13161);
} else {
}
