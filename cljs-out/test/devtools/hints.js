...
var map__13046 = top_item;
var map__13046__$1 = cljs.core.__destructure_map.call(null,map__13046);
var file = cljs.core.get.call(null,map__13046__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
}catch (e13045){var _e = e13045;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5718__auto___13047 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5718__auto___13047)){
var seen_errors_13048 = temp__5718__auto___13047;
if(cljs.core.truth_(seen_errors_13048.has(self))){
} else {
seen_errors_13048.add(self);

var temp__5720__auto___13049 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5720__auto___13049)){
var sense_13050 = temp__5720__auto___13049;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_13050)].join(''));
} else {
}
}
} else {
