...
var o11918 = temp__5718__auto__;
var temp__5718__auto____$1 = (o11918["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o11919 = temp__5718__auto____$1;
return (o11919["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__11276__auto__ = f;
return (o__11276__auto__["toString"]).call(o__11276__auto__);
} else {
return "";
}
}catch (e11920){var _ = e11920;
return "";
}});
...
try{var o__11276__auto___11922 = t;
(o__11276__auto___11922["cljs$lang$ctorPrWriter"]).call(o__11276__auto___11922,t,writer);
}catch (e11921){var __11923 = e11921;
}
...
var char_code = (function (){var o__11276__auto__ = (new String(char$));
return (o__11276__auto__["charCodeAt"]).call(o__11276__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__11276__auto__ = String;
return (o__11276__auto__["fromCharCode"]).call(o__11276__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__11924 = num_code;
switch (G__11924) {
case (1):
return (185);
...
var o__11276__auto__ = String;
return (o__11276__auto__["fromCharCode"]).call(o__11276__auto__,superscript_code);
});
/**
...
}catch (e11926){var _e__11283__auto__ = e11926;
return false;
}})())){
...
var vec__11927 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__11927,(0),null);
...
var len__4864__auto___11936 = arguments.length;
var i__4865__auto___11937 = (0);
while(true){
if((i__4865__auto___11937 < len__4864__auto___11936)){
args__4870__auto__.push((arguments[i__4865__auto___11937]));

var G__11938 = (i__4865__auto___11937 + (1));
i__4865__auto___11937 = G__11938;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__11932){
var vec__11933 = p__11932;
var ns_detector = cljs.core.nth.call(null,vec__11933,(0),null);
...
var G__11939 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__11940 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__11939;
remaining_tokens = G__11940;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq11930){
var G__11931 = cljs.core.first.call(null,seq11930);
var seq11930__$1 = cljs.core.next.call(null,seq11930);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__11931,seq11930__$1);
}));
...
var vec__11944 = cljs.core.split_with.call(null,(function (p1__11943_SHARP_){
return cljs.core.not_EQ_.call(null,p1__11943_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__11944,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__11944,(1),null);
...
var vec__11950 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__11950,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__11950,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__11953 = cljs.core.rest.call(null,remaining_tokens);
var G__11954 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__11953;
...
var vec__11957 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__11957,(0),null);
var arity = cljs.core.nth.call(null,vec__11957,(1),null);
var vec__11960 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__11960,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__11960,(1),null);
var vec__11963 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__11963,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__11963,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__11963,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__11963,(3),null);
...
var vec__11969 = result;
var munged_ns = cljs.core.nth.call(null,vec__11969,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__11969,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__11969,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__11969,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__11969,(4),null);
var arity = cljs.core.nth.call(null,vec__11969,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__11973 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__11973,(0),null);
var args = cljs.core.nth.call(null,vec__11973,(1),null);
var vec__11976 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__11976,(0),null);
var name = cljs.core.nth.call(null,vec__11976,(1),null);
...
var G__11979 = (arity + (1));
var G__11980 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__11981){
var vec__11982 = p__11981;
var arity = cljs.core.nth.call(null,vec__11982,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__11982,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__11985_SHARP_){
return cljs.core.get.call(null,arities,p1__11985_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__11986_SHARP_){
return cljs.core.drop.call(null,(2),p1__11986_SHARP_);
}),sorted_infos);
...
var args__4870__auto__ = [];
var len__4864__auto___11993 = arguments.length;
var i__4865__auto___11994 = (0);
while(true){
if((i__4865__auto___11994 < len__4864__auto___11993)){
args__4870__auto__.push((arguments[i__4865__auto___11994]));

var G__11995 = (i__4865__auto___11994 + (1));
i__4865__auto___11994 = G__11995;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__11989){
var vec__11990 = p__11989;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__11990,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq11987){
var G__11988 = cljs.core.first.call(null,seq11987);
var seq11987__$1 = cljs.core.next.call(null,seq11987);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__11988,seq11987__$1);
}));
...
var map__11998 = options;
var map__11998__$1 = cljs.core.__destructure_map.call(null,map__11998);
var include_ns_QMARK_ = cljs.core.get.call(null,map__11998__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__11998__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__11998__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__11998__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__11999 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__11999,(0),null);
var fn_name = cljs.core.nth.call(null,vec__11999,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__11999,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__11999,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__11999,(4),null);
var arity = cljs.core.nth.call(null,vec__11999,(5),null);
...
var o__11276__auto__ = f;
return (o__11276__auto__["getBasis"]).call(o__11276__auto__);
});
/**
...
}catch (e12002){var _e__11283__auto__ = e12002;
...
var G__12003 = (obj[cljs.core.first.call(null,path)]);
var G__12004 = cljs.core.rest.call(null,path);
obj = G__12003;
path = G__12004;
continue;
} else {
...
var _STAR_ = (function (accum,p__12005){
var vec__12006 = p__12005;
var bit = cljs.core.nth.call(null,vec__12006,(0),null);
var protocol = cljs.core.nth.call(null,vec__12006,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__12009){
var vec__12010 = p__12009;
var ns = cljs.core.nth.call(null,vec__12010,(0),null);
var name = cljs.core.nth.call(null,vec__12010,(1),null);
var selector = cljs.core.nth.call(null,vec__12010,(2),null);
...
var post_process = (function (p__12014){
var vec__12015 = p__12014;
var munged_name = cljs.core.nth.call(null,vec__12015,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__12015,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__12013_SHARP_){
return (obj[cljs.core.first.call(null,p1__12013_SHARP_)]);
}),sorted_matches);
