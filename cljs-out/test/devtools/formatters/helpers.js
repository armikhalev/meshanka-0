...
var G__12020 = devtools.prefs.pref.call(null,v);
v = G__12020;
continue;
} else {
return v;
...
}catch (e12021){var _e__11283__auto__ = e12021;
return false;
}})();
...
}catch (e12023){var _e__11283__auto__ = e12023;
return false;
}})();
...
}catch (e12025){var _e__11283__auto__ = e12025;
return false;
}}
}
});
...
var vec__12027 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__12027,(0),null);
var name = cljs.core.nth.call(null,vec__12027,(1),null);
...
return cljs.core.some.call(null,(function (p1__12030_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__12030_SHARP_);
}),template);
});
